/*============================================================
  Filename: CangoDragAndDrop-3v01.js
  Rev 3
  By: A.R.Collins
  ...
  16Mar17 Update to no longer use Cobj                    ARC
  28Mar17 Released as CangoDragAndDrop-3v00               ARC
  03Apr17 Update to use Cango-9v02 new draw fns           ARC
 ============================================================*/
...
*/
  ...
  function enableDragFn(grabFn, dragFn, dropFn)
  {
  ...
  Path.prototype.enableDrag = enableDragFn;
  Path.prototype.disableDrag = disableDragFn;
  Shape.prototype.enableDrag = enableDragFn;
  Shape.prototype.disableDrag = disableDragFn;
  Img.prototype.enableDrag = enableDragFn;
  Img.prototype.disableDrag = disableDragFn;
  Text.prototype.enableDrag = enableDragFn;
  Text.prototype.disableDrag = disableDragFn;
  ...
  initZoomPan = function(zpControlsId, gc, redraw)
  {
    ...
    bkg = new Shape(shapeDefs.rectangle(114, 80), {fillColor: "rgba(0, 50, 0, 0.12)"});
    bkg.translate(-17, 0);
    zpGC.render(bkg);
